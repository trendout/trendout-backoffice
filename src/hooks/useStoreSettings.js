...
export function useStoreSettings() {
  ...
  const load = useCallback(async () => {
    ...
    setSettings({
      ...
      newsletterSectionEnabled: data.newsletter_section_enabled,
      newsletterEyebrow: data.newsletter_eyebrow || "",
      newsletterTitle: data.newsletter_title || "",
      newsletterEmailPlaceholder: data.newsletter_email_placeholder || "",
      newsletterButtonLabel: data.newsletter_button_label || "",
      reviewRequestEnabled: data.review_request_enabled,
      reviewRequestDaysAfterShipping: data.review_request_days_after_shipping,
      reviewRequestSubject: data.review_request_subject || "",
      reviewRequestMessage: data.review_request_message || "",
  ...
  const updateSettings = async (patch) => {
    const columnMap = {
      ...
      heroRotationMode: "hero_rotation_mode",
      newsletterSectionEnabled: "newsletter_section_enabled",
      newsletterEyebrow: "newsletter_eyebrow",
      newsletterTitle: "newsletter_title",
      newsletterEmailPlaceholder: "newsletter_email_placeholder",
      newsletterButtonLabel: "newsletter_button_label",
      reviewRequestEnabled: "review_request_enabled",
      reviewRequestDaysAfterShipping: "review_request_days_after_shipping",
      reviewRequestSubject: "review_request_subject",
      reviewRequestMessage: "review_request_message",
