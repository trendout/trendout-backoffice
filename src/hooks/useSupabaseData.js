  ...
  const load = useCallback(async () => {
    ...
    setOrders(
      data.map((o) => ({
        ...
        orderIpCity: o.order_ip_city,
        orderIpCountry: o.order_ip_country,
        orderIpCountryCode: o.order_ip_country_code,
        orderIpLat: o.order_ip_lat,
        orderIpLng: o.order_ip_lng,
